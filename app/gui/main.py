...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.buttonDelete.setGeometry(QtCore.QRect(70, 170, 51, 25))
        self.buttonDelete.setObjectName("buttonDelete")
        self.tablePrivateKeyring = QtWidgets.QTableWidget(parent=self.centralwidget)
        self.tablePrivateKeyring.setGeometry(QtCore.QRect(70, 240, 441, 192))
        self.tablePrivateKeyring.setObjectName("tablePrivateKeyring")
        self.tablePrivateKeyring.setColumnCount(4)
        self.tablePrivateKeyring.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tablePrivateKeyring.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tablePrivateKeyring.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tablePrivateKeyring.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tablePrivateKeyring.setHorizontalHeaderItem(3, item)
        self._l4 = QtWidgets.QLabel(parent=self.centralwidget)
        self._l4.setGeometry(QtCore.QRect(240, 210, 101, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Public keys"))
        item = self.keyList.item(1)
        item.setText(_translate("MainWindow", "    PuK1"))
        item = self.keyList.item(2)
        item.setText(_translate("MainWindow", "    PuK2"))
        item = self.keyList.item(3)
        item.setText(_translate("MainWindow", "Private keys"))
        item = self.keyList.item(4)
        item.setText(_translate("MainWindow", "    PrK1"))
        ...
        item = self.tablePrivateKeyring.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "KeyID"))
        item = self.tablePrivateKeyring.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Name"))
        item = self.tablePrivateKeyring.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "User email"))
        item = self.tablePrivateKeyring.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Created at"))
        self._l4.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:700;\">PRIVATE KEYRING</span></p></body></html>"))
